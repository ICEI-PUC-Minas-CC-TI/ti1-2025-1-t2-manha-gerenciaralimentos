...
document.addEventListener("DOMContentLoaded", () => {
    ...
    dropdown.addEventListener("change", () => {
        ...
        if (type === "ambiente") {
            window.location.href = `../arthur/ambiente.html?id=${id}`;
        } else {
            window.location.href = `../arthur/ambiente.html?id=${env}&focus=${id}`;
        }
    });
    ...
    createAmbienteCard(ambiente) {
        ...
        card.addEventListener('click', (e) => {
            if (!e.target.closest('.ambiente-actions')) {
                window.location.href = `../arthur/ambiente.html?id=${ambiente.id}`;
            }
        });
